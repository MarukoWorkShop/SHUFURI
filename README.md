...
**最近部署**：2026-08-10（首页纵向滚动修复：`.app--home .app-screen__body` 补 `flex:1; min-height:0`，前端 53 文件部署至静态托管）
...
**前端访问地址（含 CDN 刷新参数）**：
`https://ai-native-d5gtc59uc47601f23-1412422924.tcloudbaseapp.com/?v=20260810a`
