...
**最近部署**：2026-08-08（小范围内测版：合并 PR #7 spotlight 点击延迟修复 + Q2 文案限额说明；4 个云函数 force 覆盖 + 前端构建产物 53 文件部署至静态托管）
...
**前端访问地址（含 CDN 刷新参数）**：
`https://ai-native-d5gtc59uc47601f23-1412422924.tcloudbaseapp.com/?v=20260808b`
