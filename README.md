...
**最近部署**：2026-08-08（全量重部署：4 个云函数 force 覆盖 + 前端构建产物 53 文件部署至静态托管） — 本次重部署含首页 Q&A Q2 文案更新
...
**前端访问地址（含 CDN 刷新参数）**：
`https://ai-native-d5gtc59uc47601f23-1412422924.tcloudbaseapp.com/?v=20260808a`
