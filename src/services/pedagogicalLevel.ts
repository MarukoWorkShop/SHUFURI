...
> = {
  ...
  zh: {
    elementary: {
      ...
      counts: 'V 3–5, G 1–2',
      exampleStyle: 'col6 ≤20 Hanzi with {字:拼音}; colloquial Mandarin',
      avoid: 'classical words without vernacular gloss; Hanzi-as-reading in col6 (e.g. {郊:郊})',
    },
    intermediate: {
      framework: 'HSK 4–5',
      ...
      counts: 'V 5–8, G 2–4',
      exampleStyle: 'col6 ≤35 Hanzi with {字:拼音}; one layer of abstraction OK',
      avoid: 'ruby in grammar_label; missing pinyin or Hanzi-as-reading in col6',
    },
    advanced: {
      ...
      counts: 'V 6–10, G 3–5',
      exampleStyle: 'col6 may be poetic with {字:拼音}; trace imagery source briefly',
      avoid: 'Hanzi-as-reading in col6; copying L lines into col6',
    },
  },
};
