...
export default function HomeSessionProvider({
  ...
  const value: HomeSessionContextValue = {
    ...
    studyFromCache: clipboardCard.studyFromCache,
    ...
    handleConfirmReanalyze: clipboardCard.handleConfirmReanalyze,
    handleConfirmStudyFallback: clipboardCard.handleConfirmStudyFallback,
